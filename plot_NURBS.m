...
function plot_NURBS(structure_NURBSPL,plot_mode,Nbox,boundarycolor)
...
if nargin < 4, boundarycolor=[0,0,0]; end
...
plot(XV,YV,'-','MarkerEdgeColor',boundarycolor,...
    'MarkerFaceColor',boundarycolor,...
